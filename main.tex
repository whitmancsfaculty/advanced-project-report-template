...
\begin{document}
\begin{titlepage}
\pagenumbering{gobble} % Do not number the title or signature page
...
%JAS: 2020 directions are to have the approval page be a separate document - 
%  uncomment to re-insert
